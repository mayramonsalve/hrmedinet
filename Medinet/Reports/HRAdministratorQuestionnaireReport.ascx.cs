...
{
    public partial class QuestionnaireReport : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsUrl())
                ...
                ReportViewer1.LocalReport.ReportPath = ViewRes.Reports.Files.HRAdministratorQuestionnaire;
        }
