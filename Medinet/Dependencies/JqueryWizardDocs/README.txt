...
that represent the pages you want to create.

Each fieldset should have 
...
of the last <fieldset> tag.

If you don't, one will be provided for you.




Now, your form is set!

To turn it into a multipage form, call the multipage 
jQuery method:
