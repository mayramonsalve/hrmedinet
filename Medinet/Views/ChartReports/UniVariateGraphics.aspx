...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
          ...
          <% int i = 0; 
            ...
            <h2 class="path"><%: ViewRes.Views.ChartReport.Graphics.UnivariateTitle%></h2>
                <ul >
                    <li><a href="#tabGeneral"><%: ViewRes.Views.ChartReport.Graphics.GeneralClimate %></a></li>
                ...
                <div id="tabGeneral">
                    ...
                    <%Html.RenderPartial("ChartsForm", Model); %> <%-- ChartsForm es para los gráficos --%>
                </div>
<%--                <div id="tabCategory">
                </div>--%>
                    <% if (Model.test.DemographicsInTests.Select(d => d.Demographic.Name).Contains("Country"))
