            ...
            <div id="myTabs-Result1">
                <div id="tabResult1-0">
                        <h1 style="padding-left:2%;">
                            <a href="#questionnairesTabs" data-rel="dialog" data-role="button" data-iconpos="notext" data-theme="f" data-inline="true" data-icon="bars"></a>
                ...
                <% foreach (MedinetClassLibrary.Models.Questionnaire questionnaire in Model.questionnairesInTest)
                   { %>
                        <div id="tabResult1-<%: questionnaire.Id %>" style="display:none;">
                            <h1 style="padding-left:2%;">
                                <a href="#questionnairesTabs" data-rel="dialog" data-role="button" data-iconpos="notext" data-theme="f" data-inline="true" data-icon="bars"></a>
                                <%:questionnaire.Name%>
                            </h1>
