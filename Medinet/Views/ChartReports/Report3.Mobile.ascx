                ...
                <% foreach (MedinetClassLibrary.Models.Questionnaire questionnaire in Model.questionnairesInTest)
                   { %>
                           ...
                           {  %>
                            <div id="tabResult3-<%: questionnaire.Id %>">
                                <h1 style="padding-left:2%;">
                                    <a href="#questionnairesTabs3" data-rel="dialog" data-role="button" data-iconpos="notext" data-theme="f" data-inline="true" data-icon="bars"></a>
                                    <%:questionnaire.Name%>
                                </h1>
                        ...
                        <% }
                           ...
                           { %>
                            <div id="tabResult3-<%: questionnaire.Id %>" style="display:none;">
                                <h1 style="padding-left:2%;">
                                    <a href="#questionnairesTabs3" data-rel="dialog" data-role="button" data-iconpos="notext" data-theme="f" data-inline="true" data-icon="bars"></a>
                                    <%:questionnaire.Name%>
                                </h1>
