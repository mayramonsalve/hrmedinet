...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.ChartReport.Graphics.FrequencyTitle %>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%}%>
    <h1 class ="testname"><%= ViewRes.Views.ChartReport.Graphics.FrequencyTitle%></h1>   
    <div id="myTabs" class="box rounded tabs">

        <div id="tabGeneral">
            <h1><a href="#tabs" data-rel="dialog" data-role="button" data-iconpos="notext" data-theme="f" data-inline="true" data-icon="bars"></a><%: ViewRes.Views.ChartReport.Graphics.GeneralFrequency %></h1>
