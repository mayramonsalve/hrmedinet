<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Medinet.Models.ViewModels.AnalyticalReportViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contenido-sistema">
        <div class="prepend-1 span-21 append-2">
            <br />
            ...
            <div class="span-24 button-padding-top">
            ...
            <div class="span-24 column last">
                ...
                <div class="prepend-1 span-8 column last">
                    <br />
                    ...
                    <p>
                        <strong><%: ViewRes.Views.Evaluation.TestInstructions.From%></strong>
                    ...
                    <p>
                        <strong><%: ViewRes.Views.ChartReport.Graphics.EmployeesUsed%></strong>
                        <%: Model.Test.EvaluationNumber%>
                    </p>
                    <p>
                        <strong><%: ViewRes.Views.ChartReport.Graphics.EmployeesWhoPerformed%></strong>
                        <%: Model.Test.CurrentEvaluations%>
                    </p>
                    <p>
                        <strong><%: ViewRes.Views.ChartReport.Graphics.PercentageEvaluationReceived%></strong>
                        <%: String.Format("{0:0.##}", pct)%>%
                    </p>
                    <p>
                        <strong><%: ViewRes.Views.Test.Create.ConfidenceLevel%>: </strong>
                        <%: Model.Test.ConfidenceLevel.Text%>
                    </p>
                    <p>
                        <strong><%: ViewRes.Views.Test.Create.StandardError%>: </strong>
            ...
            <div class="span-24">
                ...
                <p>
                    <%: ViewRes.Views.ChartReport.Graphics.TheGeneralResultsIndicate%> <%: String.Format("{0:0.##}",Model.GeneralClimate) %>%
         <%: ViewRes.Views.ChartReport.Graphics.Corresponding%><span style="<%: colorStyle %>">&nbsp;&nbsp;&nbsp;</span><%: ViewRes.Views.ChartReport.Graphics.ColorState%>
                ...
                <%if (Model.PositiveAnswersByPositionLevels != null && Model.PositiveAnswersByPositionLevels.Count > 0)
                    { %>
                <p>
                    <%: ViewRes.Views.ChartReport.Graphics.StrataLevel%><%: Levels[0]%>
        ...
        <%: ViewRes.Views.ChartReport.Graphics.Result%>
                </p>
                <br />
                <%} %>
                ...
                <% if (Model.PositiveAnswersByFOTypes != null && Model.PositiveAnswersByFOTypes.Count > 0)
                    { %>
                <p>
                    <%: ViewRes.Views.ChartReport.Graphics.FunctionallyHighest %><%: FO[0]%> (<%: String.Format("{0:0.##}", Model.PositiveAnswersByFOTypes[FO[0]])%>%)
        <% if (FO[2] != "B")
            {%><%}
                  else
        ...
        <% if (FO[5] == "W")
            {%><%: ViewRes.Views.ChartReport.Graphics.Areas %><%}
                                                   ...
                                                   {%> y <%: FO[5]%> (<%: String.Format("{0:0.##}", Model.PositiveAnswersByFOTypes[FO[5]])%>%)<%: ViewRes.Views.ChartReport.Graphics.Areas %><%}%>
                </p>
                <br />
                <%} %>
            </div>
            ...
            <div class="span-24">
                ...
                <% if (Model.ClimateByCategories != null && Model.ClimateByCategories.Count > 0)
                    { %>
                <p>
                    <%: ViewRes.Views.ChartReport.Graphics.TheHighestCategoryResults%><%: Categories[0] %> (<%: String.Format("{0:0.##}",Model.ClimateByCategories[Categories[0]]) %>%)
            <% if (Categories[2] != "B")
                {%>, <%}
                                                     else
                                                     {%><%: ViewRes.Views.ChartReport.Graphics.And%><%}%><%: Categories[1] %> (<%: String.Format("{0:0.##}", Model.ClimateByCategories[Categories[1]])%>%)
            <% if (Categories[2] == "B")
                {%>, <%}
                                                     else
                                                     {%><%: ViewRes.Views.ChartReport.Graphics.And%><%: Categories[2] %> (<%: String.Format("{0:0.##}",Model.ClimateByCategories[Categories[2]])%>%),<%}%>
            ...
            <% if (Categories[5] != "W")
                {%>, <%}
                                                     ...
                                                     {%><%: ViewRes.Views.ChartReport.Graphics.And%><%}%><%: Categories[4] %> (<%: String.Format("{0:0.##}", Model.ClimateByCategories[Categories[4]])%>%)
            <% if (Categories[5] == "W")
                {%><%: ViewRes.Views.ChartReport.Graphics.Dimensions%><%}
                                                                           else
                                                                           {%><%: ViewRes.Views.ChartReport.Graphics.And%><%: Categories[5] %> (<%: String.Format("{0:0.##}",Model.ClimateByCategories[Categories[5]])%>%)<%: ViewRes.Views.ChartReport.Graphics.Dimensions%><%}%>
                </p>
                <br />
                <%} %>
                    ...
                    <table class="display tabla">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="color: Black; text-align: center;"><%:String.Format("{0:0.##}", (vector.Value[4]*100)/Model.optionsCount)%></td>
                                <!-- Columna de promedio-->
            ...
            <div class="span-24">
                ...
                <% if (Model.ClimateByBranches != null && Model.ClimateByBranches.Count > 0)
                    { %>
                <p>
                    <%: ViewRes.Views.ChartReport.Graphics.TheHighestBranchResults%><%: Branches[0] %> (<%: String.Format("{0:0.##}", Model.ClimateByBranches[Branches[0]])%>%)
            <% if (Branches[2] != "B")
                {%>, <%}
           else
           ...
           {%><%: ViewRes.Views.ChartReport.Graphics.And%><%}%><%: Branches[4]%> (<%: String.Format("{0:0.##}", Model.ClimateByBranches[Branches[4]])%>%)
            <% if (Branches[5] == "W")
                {%><%: ViewRes.Views.ChartReport.Graphics.Branches%><%}
                                                       ...
                                                       {%><%: ViewRes.Views.ChartReport.Graphics.And%><%: Branches[5]%> (<%: String.Format("{0:0.##}", Model.ClimateByBranches[Branches[5]])%>%)<%: ViewRes.Views.ChartReport.Graphics.Branches%><%}%>
                </p>
                <br />
                <%} %>
            ...
            <div class="span-24">
                ...
                <% if (Model.ClimateByFOTypes != null && Model.ClimateByFOTypes.Count > 0)
                    { %>
                <p>
                    <%: ViewRes.Views.ChartReport.Graphics.TheHighestFOTypeResults%><%: FOTypes[0] %> (<%: String.Format("{0:0.##}", Model.ClimateByFOTypes[FOTypes[0]])%>%)
            <% if (FOTypes[2] != "B")
                {%>, <%}
             else
           ...
           {%><%: ViewRes.Views.ChartReport.Graphics.And%><%: FOTypes[2]%> (<%: String.Format("{0:0.##}", Model.ClimateByFOTypes[FOTypes[2]])%>%)<%}%>
            ...
            {%><%: ViewRes.Views.ChartReport.Graphics.And%><%: FOTypes[5]%> (<%: String.Format("{0:0.##}", Model.ClimateByFOTypes[FOTypes[5]])%>%).<%}%>
                </p>
                <br />
                <%} %>
            ...
            <div class="span-24">
                ...
                <% if (Model.ClimateByAgeRanges != null && Model.ClimateByAgeRanges.Count > 0)
                    { %>
                <p>
                    <%: ViewRes.Views.ChartReport.Graphics.TheHighestAgeRangeResults%><%: AgeRanges[0] %> (<%: String.Format("{0:0.##}", Model.ClimateByAgeRanges[AgeRanges[0]])%>%)
            <% if (AgeRanges[2] != "B")
                {%>, <%}
             else
           ...
           {%><%: ViewRes.Views.ChartReport.Graphics.And%><%: AgeRanges[2]%> (<%: String.Format("{0:0.##}", Model.ClimateByAgeRanges[AgeRanges[2]])%>%)<%}%>
            ...
            <% if (AgeRanges[5] == "W")
                {%><%: ViewRes.Views.ChartReport.Graphics.AgeRanges%><%}
                                                                 ...
                                                                 {%><%: ViewRes.Views.ChartReport.Graphics.And%><%: Branches[5]%> (<%: String.Format("{0:0.##}", Model.ClimateByBranches[Branches[5]])%>%)<%: ViewRes.Views.ChartReport.Graphics.AgeRanges%><%}%>
                </p>
                <br />
                <%} %>
            ...
            <div class="span-24">
                ...
                <p>
                    <%: ViewRes.Views.ChartReport.Graphics.TheComparativeRanking%>
                    <%:Model.Test.Company.Name%>
                    <%: ViewRes.Views.ChartReport.Graphics.IsPlaced%><%: Model.PositionAndCompaniesCount[0]%>
                    <%: ViewRes.Views.ChartReport.Graphics.FromANumber%><%: Model.PositionAndCompaniesCount[1]%><%: ViewRes.Views.ChartReport.Graphics.Companies%>
                </p>
            </div>
            <% } %>
        </div>
    ...
    <div class="span-12 column">
        &nbsp;
         <%--<button><%:Html.ActionLink("Downlad as PDF", "ConvertToPDF",new { test_id = Model.Test.Id})%></button>--%>
        <%--<%: Html.ActionLink(ViewRes.Views.ChartReport.Graphics.PrintReport, "PdfAnalytical", new { test_id = Model.Test.Id, country_id = Model.country_id, state_id = Model.state_id, region_id = Model.region_id }, new { id = "PrintPdf" })%>--%>
        <a id="PrintPdf" href="#"><%:ViewRes.Views.ChartReport.Graphics.PrintReport %></a>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script src="<%: Url.Content("~/Scripts/jsPdfWrapper.js") %>" type="text/javascript"></script>
</asp:Content>
