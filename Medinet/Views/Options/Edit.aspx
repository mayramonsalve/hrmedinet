...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
     <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.Option.Edit.TitleEdit %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contenido-sistema" class="span-24 last"> 
        <h2 class="path"><%= ViewRes.Views.Option.Edit.PathEdit %></h2>
        <div class="linea-sistema-footer"></div>
		<% using (Html.BeginForm("Edit", "Options", FormMethod.Post, new { @enctype = "multipart/form-data" })) {%>
