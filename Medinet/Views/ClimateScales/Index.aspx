...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.ClimateScale.Index.TitleIndex %>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="contenido-sistema" class="span-24 last"> 
 	    <h2 class="path"><%= ViewRes.Views.ClimateScale.Index.PathIndex%></h2>
        <div class="linea-sistema-footer"></div>
            <div class="span-23 prepend-1 last"> 
                <div id="grid_wrapper">
                    <table id="listClimateScales">
                            <tr><td>&nbsp;</td></tr>
                    </table>
                    <div id="pagerClimateScales"></div>
                </div>
            </div>
        </div>
        <div class="span-24 last">
            <%: Html.ActionLink(ViewRes.Views.ClimateScale.Index.ActionLink, "Create")%>
        </div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JsContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var myGrid = jQuery("#listClimateScales").jqGrid({
                url: '/ClimateScales/GridData/',
                datatype: 'json',
                mtype: 'POST',
          ...
          { name: 'Action3', index: 'Action3', align: "left", width: 50, resizable: true, sortable: false, search: false}],
                pager: jQuery('#pagerClimateScales'),
                rowNum: 10,
                rowList: [10, 20, 50],
                height: 220,
                sortname: 'Name',
                ...
                viewrecords: true,
                altRows: true,
                caption: '<%: ViewRes.Views.ChartReport.Graphics.ClimateScaleTab %>',
                editurl: '/ClimateScales/Delete',
                loadComplete: function () {
                    $(".ui-icon-trash").click(function () {
                        var gr = $(this).attr("id");
                        jQuery("#listClimateScales").delGridRow(gr, { reloadAfterSubmit: true });
                    });
                }
            }).navGrid('#pagerClimateScales',
            {
