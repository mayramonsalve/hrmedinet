...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.FunctionalOrganizationType.Edit.TitleEdit%>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <h2 class="path"><%= ViewRes.Views.FunctionalOrganizationType.Edit.PathEdit%></h2>
