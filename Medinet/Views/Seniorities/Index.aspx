<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Medinet.Models.ViewModels.SeniorityViewModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.Seniority.Index.TitleIndex%>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="contenido-sistema" class="span-24 last"> 
 	    <h2 class="path"><%= ViewRes.Views.Seniority.Index.PathIndex%></h2>
        <div class="linea-sistema-footer"></div>
            <div class="span-23 prepend-1 last"> 
            <div id="grid_wrapper">
                <table id="listSeniorities">
                        <tr><td>&nbsp;</td></tr>
                </table>
                <div id="pagerSeniorities"></div>
            </div>
        </div>
    </div>

    <div class="span-24 last">
        <%: Html.ActionLink(ViewRes.Views.Seniority.Index.ActionLink, "Create")%>
    </div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JsContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var myGrid = jQuery("#listSeniorities").jqGrid({
                url: '/Seniorities/GridData/',
                datatype: 'json',
                mtype: 'POST',
          ...
          { name: 'Action3', index: 'Action3', align: "left", width: 50, resizable: true, sortable: false, search: false}],
                ...
                viewrecords: true,
                altRows: true,
                caption: '<%: ViewRes.Views.ChartReport.Graphics.SeniorityTab %>',
                editurl: '/Seniorities/Delete',
                loadComplete: function () {
                    $(".ui-icon-trash").click(function () {
                        var gr = $(this).attr("id");
                        jQuery("#listSeniorities").delGridRow(gr, { reloadAfterSubmit: true });
                    });
                }
            }).navGrid('#pagerSeniorities',
            {
