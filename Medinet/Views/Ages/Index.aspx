<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Medinet.Models.ViewModels.AgeViewModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.Age.Index.TitleIndex%>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="contenido-sistema" class="span-24 last"> 
 	    <h2 class="path"><%= ViewRes.Views.Age.Index.PathIndex%></h2>
        <div class="linea-sistema-footer"></div>
            <div class="span-23 prepend-1 last"> 
                <div id="grid_wrapper">
                    ...
                    <div id="pagerAges"></div>
                </div>
            </div>
        </div>
        <div class="span-24 last">
            <%: Html.ActionLink(ViewRes.Views.Age.Index.ActionLink, "Create")%>
        </div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JsContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var myGrid = jQuery("#listAges").jqGrid({
                url: '/Ages/GridData/',
                datatype: 'json',
                mtype: 'POST',
          ...
          { name: 'Action3', index: 'Action3', align: "left", width: 50, resizable: true, sortable: false, search: false}],
                ...
                viewrecords: true,
                altRows: true,
                caption: '<%: ViewRes.Views.ChartReport.Graphics.AgeTab %>',
                editurl: '/Ages/Delete',
                loadComplete: function () {
                    $(".ui-icon-trash").click(function () {
                        var gr = $(this).attr("id");
                        jQuery("#listAges").delGridRow(gr, { reloadAfterSubmit: true });
                    });
                }
            }).navGrid('#pagerAges',
            {
