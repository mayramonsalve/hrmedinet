...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.Feature.Index.TitleIndex%>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contenido-sistema" class="span-24 last"> 
 	     <h2 class="path"><%= ViewRes.Views.Feature.Index.TitleIndex%></h2>
         <div class="linea-sistema-footer"></div>
            <div class="span-23 prepend-1 last"> 
                ...
                <br/><br/>
                <div id="grid_wrapper">
                <table id="listFeatures">
                    <tr><td>&nbsp;</td></tr>
                </table>
                <div id="pagerFeatures"></div>
                </div>
            </div>
        </div>
    <div class="span-24 last">
        <%: Html.ActionLink(ViewRes.Views.Feature.Index.ActionLink, "Create", null, new { @type_id = 0 }, new { id = "editlink" })%>
    </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JsContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var myGrid = jQuery("#listFeatures").jqGrid({
                url: '/Features/GridData',
                datatype: 'json',
                mtype: 'POST',
                postData: {
                    type_id: function () { return jQuery("#Types option:selected").val(); }
                },
                colNames: ['Id', '<%: ViewRes.Models.Shared.Name %>', '<%: ViewRes.Views.ChartReport.Graphics.Average %>', '', '', ''],
                colModel: [
                ...
                viewrecords: true,
                altRows: true,
                caption: '<%: ViewRes.Views.ChartReport.Graphics.FeatureTab %>',
                editurl: '/Features/Delete',
                loadComplete: function () {
                    $(".ui-icon-trash").click(function () {
                        var gr = $(this).attr("id");
                        jQuery("#listFeatures").delGridRow(gr, { reloadAfterSubmit: true });
                    });
                }
            }).navGrid('#pagerFeatures',
                    {
            ...
            function updateLinks() {
                value = '/Features/Create?type_id=' + $("#Types option:selected").val();
