<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<MedinetClassLibrary.Models.Questionnaire>" %>
        ...
        <div class="span-24 last"> 
            ...
            <div class="span-24 last"><%: Html.TextAreaFor(model => model.Instructions, new { @class = "input-background textArea" })%></div>
            <div><%: Html.ValidationMessageFor(model => model.Instructions)%></div>
        </div>
