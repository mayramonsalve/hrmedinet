...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.FunctionalOrganization.Create.TitleCreate %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
	<%: Html.Hidden("Select", ViewRes.Scripts.Shared.Select, new { id = "ViewRes" })%>
     <div id="contenido-sistema" class="span-24 column last"> 
        <h2 class="path"><%= ViewRes.Views.FunctionalOrganization.Create.PathCreate %></h2>
