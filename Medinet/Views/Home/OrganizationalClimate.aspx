...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.Home.Services.OrganizationalClimateTitle %>
</asp:Content>
...
<div class="page block">
    <div class="span-14 column">
        <h2 class="path">
            <%: ViewRes.Views.Home.Services.OrganizationalClimateTitle %>
        </h2>
        ...
        <div class="span-22 append-2 column last">
            <div class="col1">
                ...
                <p><%: ViewRes.Views.Home.Services.Dmsj1 %></p>
                <p><%: ViewRes.Views.Home.Services.Dmsj2 %></p>
            </div>
            <div class="linea-sistema-footer"></div>
            <div class="col1 alignJustify">
                ...
                <p> 
                    <span class="alignJustify">
                        <%: ViewRes.Views.Home.Services.Items %>
                    </span>
                </p>
                <ul class="list-separator">
                   <li><%: ViewRes.Views.Home.Services.Subitem1 %> </li>
                   <li> <%: ViewRes.Views.Home.Services.Subitem2 %></li>
                   <li> <%: ViewRes.Views.Home.Services.Subitem3 %> </li>
	               <li> <%: ViewRes.Views.Home.Services.Subitem4 %> </li>
                </ul>
            </div>
        </div>
        <div class="linea-sistema-footer"></div>
