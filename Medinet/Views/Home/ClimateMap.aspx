...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%: Html.Hidden("country", "0", new { id = "country" })%>
                <%  string rol;
                   ...
                   <%: Html.Hidden("UrlMap", "world_en", new { id = "UrlMap" })%>
    ...
    <h2 id="path"><%:ViewRes.Views.Home.Map.Global%></h2>
    <div id="click" class="span-24"><h4><%: ViewRes.Views.Home.Map.ClickCountry %></h4></div>
    <div class="clear"></div>
