...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   <%: ViewRes.Views.Shared.Shared.GenericTitle %> <%: ViewRes.Views.Home.Services.Text5 %>
</asp:Content>
...
<div class="page block">
    <div class="span-14 column">
        <h2 class="path">
            <%: ViewRes.Views.Home.Services.Text5 %>
        </h2>
        ...
        <div class="span-22 append-2 column last">
            <div class="col1">
                ...
                <p><%: ViewRes.Views.Home.Services.E360msj1%></p>
                <p><%: ViewRes.Views.Home.Services.E360msj2%></p>
                <p><%: ViewRes.Views.Home.Services.E360msj3%></p>
            </div>
            <div class="linea-sistema-footer"></div>
            <div class="col1 alignJustify">
                ...
                <ul class="list-separator">
                   <li><%: ViewRes.Views.Home.Services.E360msj4%></li>
                   <li><%: ViewRes.Views.Home.Services.E360msj5%></li>
                   <li><%: ViewRes.Views.Home.Services.E360msj6%></li>
	               <li><%: ViewRes.Views.Home.Services.E360msj7%></li>
                </ul>
            </div>
        </div>
        <div class="linea-sistema-footer"></div>
